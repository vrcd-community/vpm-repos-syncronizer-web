...
const { data: repo } = await useFetch<BrowserRepo>('http://localhost:5218/browser/repos/' + route.params.repo)
const { data: packages } = await useFetch<BrowserPackages[]>(`http://localhost:5218/browser/repos/${route.params.repo}/packages`)
